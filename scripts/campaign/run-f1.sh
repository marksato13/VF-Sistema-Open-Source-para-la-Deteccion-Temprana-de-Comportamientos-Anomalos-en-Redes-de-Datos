...
ppi_validate_id "$id"
case "$scenario" in
  http|https|http-concurrent|http-multi|http-missing|https-sessions|dns-valid|dns-nxdomain|dns-mixed|dns-multi|ping|tcp-refused|iperf-tcp|iperf-udp|mixed-light) ;;
