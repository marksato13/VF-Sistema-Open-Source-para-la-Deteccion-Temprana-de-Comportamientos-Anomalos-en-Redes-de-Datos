...
| **Puntos abiertos en este registro** | **25** |
| **Ya corregidos durante esta fase** | **15** (fuera del registro, listados como resueltos en cada sección) |
...
Contiene los 25 puntos abiertos. Un punto sin celda es un punto sin plan.
