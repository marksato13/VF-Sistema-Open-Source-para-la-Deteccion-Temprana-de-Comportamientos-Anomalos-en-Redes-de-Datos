...
| **Puntos abiertos en este registro** | **22** |
| **Ya corregidos durante esta fase** | **18** (fuera del registro, listados como resueltos en cada sección) |
...
Contiene los 22 puntos abiertos. Un punto sin celda es un punto sin plan.
