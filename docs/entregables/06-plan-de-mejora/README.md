...
| **Ya corregidos durante esta fase** | **12** (fuera del registro, listados como resueltos en cada sección) |
...
Contiene los 28 puntos abiertos. Un punto sin celda es un punto sin plan.

|  | **Minutos–Horas** | **Días** | **Semanas** |
|---|---|---|---|
| 🔴 **Crítico** | **P1 · Hacer ya**<br>D-01 declarar selección post hoc<br>D-08 publicar dataset y modelo<br>D-20 actualizar el PPI | **P2 · Planificar**<br>D-02 ablación por capas<br>D-29 datasheet canónico | **P3 · Trabajo futuro**<br>D-11 recalibrar con tráfico pesado |
