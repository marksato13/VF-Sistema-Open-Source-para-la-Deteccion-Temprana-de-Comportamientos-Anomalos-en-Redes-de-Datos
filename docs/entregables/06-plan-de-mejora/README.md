...
| **Puntos abiertos en este registro** | **23** |
| **Ya corregidos durante esta fase** | **17** (fuera del registro, listados como resueltos en cada sección) |
...
Contiene los 23 puntos abiertos. Un punto sin celda es un punto sin plan.
