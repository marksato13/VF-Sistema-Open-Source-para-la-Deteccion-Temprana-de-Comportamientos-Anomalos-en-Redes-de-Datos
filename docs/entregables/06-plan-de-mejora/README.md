...
| **Puntos abiertos en este registro** | **24** |
| **Ya corregidos durante esta fase** | **16** (fuera del registro, listados como resueltos en cada sección) |
...
Contiene los 24 puntos abiertos. Un punto sin celda es un punto sin plan.

|  | **Minutos–Horas** | **Días** | **Semanas** |
|---|---|---|---|
| 🔴 **Crítico** | **P1 · Hacer ya**<br>D-01 declarar selección post hoc<br>D-20 actualizar el PPI | **P2 · Planificar**<br>D-02 ablación por capas | **P3 · Trabajo futuro**<br>D-11 recalibrar con tráfico pesado |
...
| 🟡 **Medio** | **P2**<br>D-04 pruebas de significancia<br>D-06 documentar determinismo<br>D-22 revertir acceso root | **P3**<br>D-10 escenarios faltantes<br>D-19 pruebas de evasión<br>D-27 heurístico sin calibrar<br>D-28 sin juicio experto | **P4 · Declarar**<br>D-13 segundo umbral (LIMIT)<br>D-25 tamaño muestral |
