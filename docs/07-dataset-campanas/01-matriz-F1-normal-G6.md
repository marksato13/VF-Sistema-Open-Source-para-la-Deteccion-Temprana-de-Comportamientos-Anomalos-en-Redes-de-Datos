...
> **Seguimiento:** el volumen dedicado resolvió el gate de capacidad. Los canarios oficiales DNS mixto R01, los ocho tamaños HTTP/HTTPS R01, HTTP 404 R01, recambio TLS R01, los dos HTTP multidestino R01 y HTTP-C2 R01 fueron aceptados; quedan 131 celdas. Ver `06-primer-canario-oficial-F1.md` a `19-canario-HTTP-C2-F1.md`.
