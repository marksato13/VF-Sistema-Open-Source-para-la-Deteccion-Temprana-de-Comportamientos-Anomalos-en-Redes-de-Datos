...
> **Seguimiento:** el volumen dedicado resolvió el gate de capacidad. Los canarios oficiales DNS mixto R01, HTTP 10/100/500 MB/1 GB R01 y HTTPS 10/100 MB R01 fueron aceptados; quedan 138 celdas. Ver `06-primer-canario-oficial-F1.md` a `12-canario-HTTPS-100MB-F1.md`.
