...
> **Seguimiento:** el volumen dedicado resolvió el gate de capacidad. Los canarios oficiales DNS mixto R01, los ocho tamaños HTTP/HTTPS R01 y HTTP 404 R01 fueron aceptados; quedan 135 celdas. Ver `06-primer-canario-oficial-F1.md` a `15-canario-HTTP-404-5-F1.md`.
