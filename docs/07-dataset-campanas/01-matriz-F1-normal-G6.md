...
> **Seguimiento:** el volumen dedicado resolvió el gate de capacidad. Los canarios oficiales DNS mixto R01, los ocho tamaños HTTP/HTTPS R01, HTTP 404 R01 y recambio TLS R01 fueron aceptados; quedan 134 celdas. Ver `06-primer-canario-oficial-F1.md` a `16-canario-TLS-SESSIONS-20-F1.md`.
