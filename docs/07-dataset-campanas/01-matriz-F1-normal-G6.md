...
> **Seguimiento:** el volumen dedicado resolvió el gate de capacidad. Los canarios oficiales DNS mixto R01, HTTP 10/100/500 MB/1 GB R01 y HTTPS 10 MB R01 fueron aceptados; quedan 139 celdas. Ver `06-primer-canario-oficial-F1.md` a `11-canario-HTTPS-10MB-F1.md`.
