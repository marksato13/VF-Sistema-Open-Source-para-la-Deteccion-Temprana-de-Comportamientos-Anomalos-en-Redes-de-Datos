...
> **Seguimiento:** el volumen dedicado resolvió el gate de capacidad. Los canarios oficiales DNS mixto R01, HTTP 10 MB R01 y HTTP 100 MB R01 fueron aceptados; quedan 142 celdas. Ver `06-primer-canario-oficial-F1.md`, `07-canario-HTTP-10MB-F1.md` y `08-canario-HTTP-100MB-F1.md`.
