...
> **Seguimiento:** el volumen dedicado resolvió el gate de capacidad. Los canarios oficiales `F1N-DNS-MIXED-20-2-R01` y `F1N-HTTP-10MB-R01` fueron aceptados; quedan 143 celdas. Ver `06-primer-canario-oficial-F1.md` y `07-canario-HTTP-10MB-F1.md`.
