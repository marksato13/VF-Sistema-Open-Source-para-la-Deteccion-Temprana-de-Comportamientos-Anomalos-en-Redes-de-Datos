...
- G6 posee la matriz versionada `f1-normal-v1`: 27 perfiles, cinco repeticiones y partición fija R01–R03/R04/R05 por campaña. Estima 33.67 GB de PCAP. El gate completo falla con la reserva exigida de 20 GiB, de modo que solo están autorizados pilotos hasta ampliar/archivar. Cuatro pilotos DNS/HTTP/RST/TLS pasaron con cero drops; HTTP tuvo 7,247/11,234 paquetes de 500–1500 bytes, RST produjo ratio 0.5 y TLS registró 20 sesiones. Siguen excluidos como calibración. Diseño y evidencia: `docs/07-dataset-campanas/`.
- El ensamblador `scripts/dataset/build_f1_dataset.py` exige las 135 campañas, verifica bundles, recalcula matriz/esquema desde el commit, rechaza calibraciones y reconstruye el split por repetición. Actualmente debe reportar 0 aceptadas, 4 pilotos excluidos y 135 faltantes. Revisión adversarial: `docs/04-revisiones-claude/2026-07-21-ensamblador-F1.md`.
