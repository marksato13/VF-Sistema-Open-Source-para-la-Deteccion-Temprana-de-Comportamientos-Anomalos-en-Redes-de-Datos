...
- El aislamiento G7 ya está **APTO OPERACIONAL / PERSISTENCIA PENDIENTE**: las cuatro NIC externas están `DOWN`, `.111-.114` no responden por ICMP/TCP22, el camino LAN→Sensor→DMZ pasa y `CAL-G7-ISOLATION-003` correlacionó 56 paquetes PCAP, delta Suricata 60, 21 EVE, nueve muestras, hashes correctos y cero drops. Es calibración excluida. Antes del canario oficial falta reiniciar el Servidor y demostrar que `.112` no reaparece. Evidencia: `docs/05-plan-pruebas/14-cierre-operacional-G7.md`; revisión: `docs/04-revisiones-claude/2026-07-22-cierre-operacional-G7.md`.
