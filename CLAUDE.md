...
- El ensamblador `scripts/dataset/build_f1_dataset.py` exige las 145 campañas `v2`, verifica bundles, recalcula matriz/esquema desde el commit, rechaza calibraciones y reconstruye el split por repetición. En el volumen oficial reporta 9 aceptadas (`DNS-MIXED-20-2/R01` y los ocho tamaños HTTP/HTTPS R01), 0 inválidas, 0 advertencias y 136 faltantes; los cinco pilotos históricos permanecen excluidos en la raíz heredada. Revisión inicial: `docs/04-revisiones-claude/2026-07-21-ensamblador-F1.md`.
