...
- VM01 conserva un único disco raíz de 70 GiB y tiene pendiente añadir un segundo VMDK thin de 150 GiB. Las campañas oficiales exigen `/srv/ppi-evidence/artifacts`, un montaje real, marcador válido y espacio suficiente; no se debe ejecutar F1 oficial sobre la raíz. Diseño y procedimiento: `docs/08-almacenamiento/01-disco-evidencias-vm01.md`.
